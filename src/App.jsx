        ...
        <div className=" flex flex-wrap md:justify-evenly">
          <div className="md:w-[50%] w-full md:relative">
            <div className=" md:absolute md:left-20 md:top-20 mx-2">
              <h5 className=" uppercase text-sm  text-orange-600 font-semibold">
                best destinations around the world
              </h5>
              <h1 className="text-5xl font-semibold text-[#181E4B] heading">
                Travel,
              ...
              <div className=" w-96 my-5">
                <p className="lg:text-[10px] text-lg">
              ...
              <div className="flex items-center gap-5">
                ...
                <div className="flex items-center gap-3">
                  <div class="relative w-10 h-10 bg-[#e9726a] rounded-full flex items-center justify-center">
          ...
          <div className=" md:w-[50%] w-full relative">
            ...
            />
            <img src="/images/plan.png" alt="" className=" absolute md:top-16 top-10 left-20 md:left-24  w-20"/>
            <img src="/images/plan.png" alt="" className=" absolute md:top-28 top-20 right-0 md:right-40  w-20"/>
          </div>
        </div>
      </div>
      <div className=" min-h-screen w-full flex justify-evenly  flex-wrap mx-3">
        <div className=" md:w-[50%] w-full md:relative">
          <div className=" md:absolute left-20">
            <h1 className=" text-gray-400 font-semibold">Easy and fast</h1>
            ...
            <div className="  py-3">
              <div className=" my-3 flex gap-4 items-start w-96">
                <div
                  className={` w-16 h-10 bg-[#F0BB1F] rounded-lg flex justify-center items-center`}
                >
                  <GiWoodFrame />
                </div>
                <div>
                  <h1 className="text-[#5E6282] font-semibold">
                    Choose Destination
                  </h1>
              ...
              <div className=" my-3 flex gap-4 items-start w-96">
                <div
                  className={` w-16 h-10 bg-[#F15A2B] rounded-lg flex justify-center items-center`}
                >
                  <LiaWaterSolid />
                </div>
                <div>
                  <h1 className="text-[#5E6282] font-semibold">Make Payment</h1>
                  <p className="text-[#5E6282]">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Labore, a.
                  </p>
              ...
              <div className=" my-3 flex gap-4 items-start w-96">
                <div
                  className={` w-16 h-10 bg-[#006380] rounded-lg flex justify-center items-center`}
                >
                  <PiTaxiLight />
                </div>
                <div>
        ...
        <div className=" md:w-[50%] w-full relative">
          <div className=" absolute w-60 rounded-lg h-72 bg-[#FFFFFF] shadow-xl mt-20 z-50">
            ...
            <div className="px-4">
              <h1 className=" text-[#080809] py-1">Trip To Greece</h1>
              <p className="text-[12px] text-[#84829A] font-semibold">
          ...
          <div className=" w-48 z-50 h-20  rounded-e-lg bg-[#FFFFFF] shadow-xl absolute top-[230px]  left-40 flex">
